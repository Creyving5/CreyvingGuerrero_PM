...
typedef struct          //Declaracion  de la estrcutura vendedor.
{
...
//Esta funcion se utiliza para generar un lisatdo de todos aquellos vendedores que en el ano vendieron menos de $300,000.
{
    int I,J;
    float SUM;
