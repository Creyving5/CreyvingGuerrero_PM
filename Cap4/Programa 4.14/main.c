...
void Rango(int);       //Propotipo de funcion.
...
int RA4 = 0;
int RA5 = 0;
//El uso de variables globales no es muy recomendable. En estos problemas se utilizan unicamente con el onjetivo de que el lector pueda observar la forma en que se aplican.
