...
void main(void)
{
    ...
    strncpy(cad1, cad0);
    //La funcion strncpy permite copiar una cadena de caracteres completa. En este caso se copia la cadena cad0 a cad1. Si el espacio reservado para cad1 es menor que el de cad0, se genera un error en la ejecucion del programa.
    printf("\nPrueba de la funcion strncpy. Se copia la cadena cad0 a cad1: %s\n", cad1);

    strncpy(cad1, cad3);
    printf("\nPrueba de la funcion strncpy. Se copia la cadena cad3 a cad1: %s\n", cad1);

    strncpy(cad1, "XX");
    printf("\nPrueba de la funcion strncpy. Se copia la cadena XX a cad1: %s\n", cad1);
    ...
    strncat(cad0, cad3);
    //La funcion strncat permite incorporar una cadena de caracteres a otra cadena dada. En este caso se agrega la cadena cad3 a cad0. Si el espacio reservado para cad0 es menor a lo que se debe almacenar se genera un error de ejecucion.
    printf("\nPrueba de la funcion strncat. Se incorpora la cadena cad3 a cad0: %s\n", cad0);

    strncat(cad1, "YY");
    printf("\nPrueba de la funcion strncat. Se incorpora la cadena YY a cad1: %s\n", cad1);
    ...
    printf("\nPrueba de la funcion strstr. Se trata de localizar la cadena Mexico dento de cad0: %s\n", cad0);
    ...
    printf("\nPrueba de la funcion strstr. Se trata de localizar la cadena Guatemala dento de cad0: %s\n", cad0);
}
