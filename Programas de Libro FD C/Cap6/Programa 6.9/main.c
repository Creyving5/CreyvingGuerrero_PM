...
//Esta funcion se utiliza tanto para calcular el módulo entre el indice del arreglo unidimensional y 3, como para llamar a las funciones correspondientes para resolver el problema.
{
    int I;
    for (I=0; I<N; I++)
        switch (I%3)
...
//Esta funcion calcula el coeciente entre una productoria y una sumatoria.
{
    int I;
...
//Esta funcion obtien el resultado de la pproductoria.
{
    int I;
    float PRO = 1.0;
    for (I=N; I<M; I++)
