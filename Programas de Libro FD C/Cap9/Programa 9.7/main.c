...
//El programa lee informacion de los alumnos de una escuela, almacenada en un archivo. Utiliza una funcion para realizar la lectura, pero el archivo se abre y cierra desde el programa principal.
