...
//Empresa textil.
//El programa, al recibir un arreglo tridimensional que contiene información sobre las ventas mensuales de tres departamentos en los ultimos ocho años, genera informacion estadistica valiosa para la empresa.
